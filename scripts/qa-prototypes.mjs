...
ok('CBT-I crisis selection immediately routes to safety result', cbti.includes("choice.dataset.choice==='crisis'") && cbti.includes('intakeStep=5') && cbti.includes('href="tel:109"'));
...
ok('CBT-I OSA selection replaces home sleep-window advice and refreshes diary hint', cbti.includes('homeSleepWindow') && cbti.includes('OSA 평가 우선') && cbti.includes('수면제한·침대시간 축소 보류') && cbti.includes('recalcDiary();'));
